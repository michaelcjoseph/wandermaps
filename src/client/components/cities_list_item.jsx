...
const CitiesListItem = (props) => {
  ...
  return (
    <Link to={"/" + props.item.id} >
      <div className={"cities-list-item display-block position-relative overflow-hidden center-align col-xs-12 col-md-6 " + getMapItemBorder()} >
        <div className="position-relative position0">
          <img className="cities-list-item-img position-relative display-inline-block left0" src={getImageUrl()} alt={props.item.city}/>
        </div>
